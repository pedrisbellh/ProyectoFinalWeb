    ...
    <div class="flex justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <div class="fixed inset-0 transition-opacity">
            ...
            <div class="inline-block align-botton bg-white rounded-lg text-left overflow-hidden shadow-x1 transform transition-all  sm:my-8  sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="model-headline">
                <h1 class="text-center block text-gray-700 text-sm font-bold md-2 py-4 px-4">Insertar Usuario</h1
                ...
                <form>
                    ...
                    <div class="mt-4">
                        ...
                        <select id="rol" class="block mt-1 w-full" name="rol" wire:model="rol" :value="old('rol')" required autofocus autocomplete="rol" >
